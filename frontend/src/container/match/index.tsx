    ...
    <MatchWrapper>
      {data.map((data, index) => (
        <TinderCard
          ...
          key={data.username}
          onSwipe={(dir) => swiped(dir, data.username, index)}
          onCardLeftScreen={() => outOfFrame(data.username, index)}
